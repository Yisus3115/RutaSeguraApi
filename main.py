...
@app.get('/ini/{ini}/end/{end}')
def home(ini:int, end:int):

    prueba = None
    dic = {}

    f = Graph(len(emptyGraph))

    f.graph = emptyGraph

    prueba = f.dijkstra(ini, end)

    dic["Camino"] = {"Nodos": prueba[1], 'Peso':prueba[0]}
